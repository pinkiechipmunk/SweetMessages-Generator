...
genText.addEventListener("click", function() {
  let messages = [
    ...
    "no one else can play your part, so embrace the beautiful, unique life that only you can live.",
    "you are resilient. you are valuable. you have an inner strength that has carried you this far and will continue to carry you forward",
    "you are not a drop in the ocean. You are the entire ocean in a drop",
    "when you feel like you’ve reached the end of your rope, tie a knot in it and hold on. things will get better",
    "someday, everything will make perfect sense. so, for now, laugh at the confusion, smile through the tears, and keep reminding yourself that everything happens for a reason, rafael:)",
  ]
